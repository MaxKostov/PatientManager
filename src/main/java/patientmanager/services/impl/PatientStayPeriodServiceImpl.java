...
@Service
@Slf4j
public class PatientStayPeriodServiceImpl implements PatientStayPeriodService {
    private static final Logger logger = LoggerFactory.getLogger(PatientStayPeriodServiceImpl.class);
    private final PatientStayPeriodRepo patientStayPeriodRepo;
    private final PatientRepo patientRepo;

    @Autowired
    public PatientStayPeriodServiceImpl(PatientStayPeriodRepo patientStayPeriodRepo, PatientRepo patientRepo) {
    ...
    public List<PatientStayPeriod> getFilteredPeriods(Integer month, Integer voucher, Integer year, Boolean active) {
